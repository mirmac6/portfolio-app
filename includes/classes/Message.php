...
class Message {
	...
	public function getConvosDropdown($data, $limit) {
		...
		if($count > $limit)
			...
			$return_string .= "<input type='hidden' class='noMoreDropdownData' value='true'> <p style='text-align: center;'>No more messages to load!<br><a href='messages.php'>New Message</a></p>";
